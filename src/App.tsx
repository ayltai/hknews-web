import { IconButton, SvgIcon, Switch, Typography, withStyles } from '@material-ui/core';
...
const BaseApp : React.FunctionComponent<IProps> = (props : any) : React.ReactElement => {
...
export const App : any = withStyles(styles)(BaseApp);
